...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "ruskdeskxryyds*".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.kfile.top"];
pub const PUBLIC_RS_PUB_KEY: &str = "Abcdefgxryyds";
